...
try {
  ...
  assert(health.dataLayerVersion === 'v0.7.0', `dataLayerVersion=${health.dataLayerVersion}`);
  ...
  assert(places.dataLayerVersion === 'v0.7.0', `places version=${places.dataLayerVersion}`);
