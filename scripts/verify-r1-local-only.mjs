...
const reset=(await readFile('scripts/local-reset-r1.mjs','utf8')).replace(/\r\n/g,'\n');
const recommendation=(await readFile('src/recommendation/recommendPlaces.ts','utf8')).replace(/\r\n/g,'\n');
const integration=(await readFile('scripts/verify-r1-integration-local.mjs','utf8')).replace(/\r\n/g,'\n');
const releaseGate=(await readFile('scripts/verify-r1-release-gate.mjs','utf8')).replace(/\r\n/g,'\n');
